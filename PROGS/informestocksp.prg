...
REPORT FORM infostockSP FOR tipoproducto="00" OR BETWEEN(VAL(tipoproducto),1,12) PREVIEW 
REPORT FORM infostockSP FOR tipoproducto="00" OR BETWEEN(VAL(tipoproducto),1,12) NOCONSOLE TO PRINTER PROMPT 
