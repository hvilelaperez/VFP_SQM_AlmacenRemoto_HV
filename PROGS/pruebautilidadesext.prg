...
PUBLIC Rk01,Rk02,Rk03,Rk04,Rk05,Rk06
...
SELECT a.*,CAST(00 as n(4,0)) as Rank FROM base01 as a ORDER BY totalutil DESC  INTO CURSOR base01x READWRITE 
...
REPORT FORM rankutilidxcliexvend FOR vendedor='MB' preview
REPORT FORM rankutilidxcliexvend FOR vendedor='MB' NOCONSOLE TO PRINTER PROMPT 
