...
IF lnHandle > 0
    ...
    cmd1=SQLEXEC(lnHandle," SELECT a.producto,SUM(a.cantidad-a.cantidevuelta) as Canti FROM detafacturas a,factura b "+;
                          " WHERE a.unico=b.unico and b.codigoC='T006' and b.serie=1 and b.estado<>'AN' and "+;
                          " fecha>=?My365 and fecha<=?hoy group by 1 order by 1 ","MiInfoD")    
